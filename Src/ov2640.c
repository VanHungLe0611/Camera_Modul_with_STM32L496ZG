...
const unsigned char OV2640_480x272[][2] = {
    ...
    {OV2640_SENSOR_COM8,
     0xe5}, /* Common control 8 - auto AGC, auto AEC, banding filter on */
    ...
    {OV2640_SENSOR_COM3,
     0x3c}, /* Common control 3 - banding 50Hz manual, video after snapshot */
    ...
    {0x5a, 0x57}, /* Reserved                              */
    {OV2640_SENSOR_COM7,
     0x00}, /* Common control 7 - Resolution UXGA, no zoom, no test pattern */
 ...
 */
void CAMERA_IO_Init(void) { I2Cx_Init(); }
